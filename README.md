...
The application also includes useful features like counting total study sessions, calculating total study time, and saving/loading records using JSON file handling.
